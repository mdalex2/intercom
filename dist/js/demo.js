...
$(function () {
  ...
  function get(name) {
    if (typeof (Storage) !== 'undefined') {
      ...
      window.alert('Debe actualizar su navegador para poder mostrar el gráfico correctamente!')
    }
  }
  ...
  // Layout options
    ...
    //+ '<input id="chk_fijo" name="chk_fijo" type="checkbox"data-layout="fixed"class="pull-right"/> '
    //+ 'Diseño fijo'
    //+ '</label>'
    ...
    + 'Expandir barra al pasar el mouse'
    + '</label>'
  ...
  var $skinPurpleLight =
        $('<li />', { style: 'float:left; width: 33.33333%; padding: 5px;' })
          .append('<a href="javascript:void(0)" data-skin="skin-purple-light" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">'
            ...
            + '<div><span style="display:block; width: 20%; float: left; height: 20px; background: #f9fafc"></span><span style="display:block; width: 80%; float: left; height: 20px; background: #f4f5f7"></span></div>'
            + '</a>'
            + '<p class="text-center no-margin" style="font-size: 12px">Violeta claro</p>')
