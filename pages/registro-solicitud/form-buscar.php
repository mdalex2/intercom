<!-- Main content -->
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Consultar solicitudes</h3>
        ...
        <div class="box-body">
          <div class="row">
		  <form action="registro-solicitud.php" id="frm_buscar" name="frm_buscar" method="post" autocomplete="off">
            <div class="col-md-3">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
				  ...
				  ?>
				  <a href="registro-solicitud.php?accion=<?php echo $accion_new_encrip;?>" class="btn btn-app">
