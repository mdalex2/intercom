...
if ($saldo_disponible>=$txt_monto):
	...
	$sql="INSERT INTO cuentas_bancos_movimientos (id_cate_tipo_movi,id_cuenta,num_ref,monto,notas,id_oper,fecha_mov,fecha_reg) VALUES (:id_cate_tipo_movi,:id_cuenta,:num_ref,:monto,:notas,:id_oper,:fecha_mov,:fecha_reg)";
	...
	$notas='Débito por transferencias a mayoristas';
