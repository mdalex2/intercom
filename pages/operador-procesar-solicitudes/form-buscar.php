<!-- Main content -->
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
		  <form action="procesar-solicitud.php" id="frm_buscar" name="frm_buscar" method="post" autocomplete="off">
            <div class="col-md-3">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
				  ...
				  ?>
				  <a id="btn_mostrar_todos" href="#" class="btn btn-app" onClick="mostrar_solicitudes_pendientes();">
                	<i class="fa fa-list-alt"></i> Mostrar pendientes
              	  </a>
